...
<div style="text-align:center">
  ...
  <span class="dot" onclick="currentSlide(3)"></span> 
      ...
      <h3>UREĐENJE I ODRŽAVANJE ZELENIH POVRŠINA</h3>
      <p>PROJEKTOVANJE, PLANIRANJE, IZGRADNJA, UREĐENJE I ODRŽAVANJE ZELENIH POVRŠINA</p>
        <p>-TRAVNJAKA, DVORIŠTA, OKUČNICA</p>
        <p>-ŽIVE OGRADE</p>
        <p>-GRMLJA I DRVEĆA</p>
        <p>-SEZONSKOG CVIJEĆA</p>
        <p>-STAZA I TROTORA</p>
        <p>-IGRALIŠTA ZA DJECU</p>
        <p>-PARKOVA, MEZARA, GROBLJA</p>
        <p>-GABIONA I OGRADA</p>
        <p>-UKRASA ZA VRT</p>
    </div>
    <div class="col-sm-2 sidenav">
      <div class="well">
